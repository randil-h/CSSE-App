...
export default function Subscribe_newsletter() {
    return (
        <div className=" bg-sky-100 py-6 sm:py-24 lg:py-6">
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8  lg:max-w-none lg:grid-cols-2">
                    <div className="max-w-xl lg:max-w-lg gap-y-4">
                        ...
                        <p className="mt-2 text-base leading-8 text-gray-800">
                            Sign up to receive weekly updates of product postings and news from Binn.
                        </p>
                        <div className="mt-2 flex max-w-md gap-x-4">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="min-w-0 flex-auto rounded-full border-0 bg-white px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-sky-500 sm:text-sm sm:leading-6"
                                placeholder="Enter your email"
                            />
                            <button
                                type="submit"
                                className="flex-none rounded-full bg-emerald-900 px-3.5 py-2.5 text-sm font-semibold text-gray-200 shadow-sm hover:bg-emerald-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500"
                            >
                                Subscribe
                            </button>
                        </div>
