...
export default function SpecialCollectionHistory() {
    ...
    const breadcrumbItems = [
        { name: 'Schedules', href: '/schedules/history' },
    ];
        ...
        <div className="min-h-screen flex flex-col bg-white">
            <div className="sticky top-0 z-10">
                ...
                <div className="bg-green-200 w-full h-12 flex items-center justify-between px-4">
                    <div className="text-gray-700 font-semibold text-left sm:text-center flex-1">Special Waste Collection History</div>
                    <button
            ...
            <div className="flex flex-1 relative">
                {/* Sidebar */}
                {isSidebarVisible && (
                    <div className="fixed top-0 left-0 w-64 h-full bg-gray-100 shadow-lg z-40">
                        <SideBar />
                    </div>
                )}
                ...
                <div className={`flex-1 p-4 transition-all duration-300 ease-in-out ${isSidebarVisible ? 'lg:ml-64' : ''}`}>
                    <div className="w-full max-w-6xl mx-auto">
                        <h2 className="text-2xl font-bold mb-6 text-left">Special Waste Collection History</h2>
                        <div className="flex flex-col lg:flex-row">
                            <div className="w-full lg:w-1/2">
                                <div className="flex justify-between items-center">
                                    <h3 className="text-xl font-bold mb-6">Past Schedules</h3>
                                    <button
                                ...
                                <ul className="space-y-2">
                                    {history.map((item) => {
                                        ...
                                        return (
                                            <li key={item._id}
                                                className="p-4 border rounded-lg flex justify-between items-center bg-gray-100 hover:bg-gray-200 transition-shadow duration-300">
